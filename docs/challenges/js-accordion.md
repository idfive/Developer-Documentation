...
- Uses modular CSS (I.E. BEM, SMACSS, etc) and includes animations for sections expanding and collapsing.
...
- All custom code, no NPM modules aside from build tools like Vite, etc.
